...
const sizes = [
  { name: "360", w: 360, h: 1400 },
  { name: "390", w: 390, h: 1400 },
  { name: "414", w: 414, h: 1400 },
  { name: "768", w: 768, h: 1400 },
  { name: "1280", w: 1280, h: 1400 },
];

const routes = ["today", "borrowers", "money", "settings"];
...
for (const s of sizes) {
  ...
  for (const route of routes) {
    ...
    await page.screenshot({
      path: `/root/projects/apple-website/shot-phase-a-${route}-${s.name}.png`,
      fullPage: false,
    });
  }
  await ctx.close();
